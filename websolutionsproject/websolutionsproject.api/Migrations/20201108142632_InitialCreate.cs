...
namespace websolutionsproject.api.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "UQ_ActorMovie_ActorId_MovieId",
                table: "ActorMovies",
                columns: new[] { "ActorId", "MovieId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ_Actor_FirstName_LastName_Birth",
                table: "Actors",
                columns: new[] { "FirstName", "LastName", "Birth" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ_Director_FirstName_LastName_Birth",
                table: "Directors",
                columns: new[] { "FirstName", "LastName", "Birth" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ_Favorite_UserId_MovieId",
                table: "Favorites",
            ...
            migrationBuilder.CreateIndex(
                name: "UQ_Review_Rating_Date_UserId_MovieId",
                table: "Reviews",
                columns: new[] { "Rating", "Date", "UserId", "MovieId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ_UserFollower_FollowerId_FollowingId",
                table: "UserFollowers",
